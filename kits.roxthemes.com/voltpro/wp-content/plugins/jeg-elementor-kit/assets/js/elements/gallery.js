! function(e) {
    ...
    class r extends elementorModules.frontend.handlers.Base {
        ...
        bindEvents() {
            const e = this,
                t = "masonry" == e.elements.$wrapper.data("grid") ? "masonry" : "fitRows",
                r = parseFloat((e.elements.$wrapper.data("animation-duration") / 1e3).toFixed(2)).toString() + "s";
            ...
            })), e.onInitGallery(), e.onClickFilterButton(), e.onClickLoadMoreButton(), e.onFormChange()
        }
        onInitGallery() {
            const e = this;
            e.elements.$filter.each((function() {
                jQuery(this).on("click", (function(t) {
                    ...
                    e.elements.$filter.removeClass("active"), jQuery(this).addClass("active"), e.elements.$active_label = e.$element.find(r.active_label), e.grid.isotope({
                        filter: function() {
                            ...
                            if (i.length > 0) {
                                ...
                                r = "*" != e ? (o.toLowerCase().includes(n.toLowerCase()) || l.toLowerCase().includes(n.toLowerCase())) && t.includes(e) : o.toLowerCase().includes(n.toLowerCase()) || l.toLowerCase().includes(n.toLowerCase())
                            } else r = "*" == e || t.includes(e);
                            return r
                        }
                    }), i.length > 0 && (o.text(jQuery(this).text()), l.removeClass("open-controls"))
                }))
            }))
        }
        onClickFilterButton() {
            ...
            e.elements.$filter_button.on("click", (function(t) {
                ...
                r.hasClass("open-controls") ? r.removeClass("open-controls") : r.addClass("open-controls")
            }))
        }
        onFormChange() {
            const e = this,
                t = e.elements.$filter_form;
            void 0 !== t && t.on("change paste keyup", (function() {
                ...
                e.grid.isotope({
                    filter: function() {
                        const r = jQuery(this).find(".item-title").text(),
                            ...
                            l = "*" !== e.elements.$active_label.data("filter") ? e.elements.$active_label.data("filter").substring(1) : "*";
                        let i = !1;
                        return i = "*" == l ? r.toLowerCase().includes(t.toLowerCase()) || n.toLowerCase().includes(t.toLowerCase()) : (r.toLowerCase().includes(t.toLowerCase()) || n.toLowerCase().includes(t.toLowerCase())) && o.includes(l), i
                    }
                })
            }))
        }
            ...
            e.elements.$load_more.on("click", (function(r) {
                ...
                if (o > n)
                    if (o - l - n > 0) {
                        ...
                        e.grid.append(r).isotope("reloadItems").isotope(), e.grid.imagesLoaded().progress((function() {
                            e.grid.isotope("layout")
                        ...
                        e.grid.append(r).isotope("reloadItems").isotope(), e.grid.imagesLoaded().progress((function() {
                            e.grid.isotope("layout")
                        })), e.elements.$wrapper.attr("data-current-loaded", o), e.elements.$load_more.find(".load-more-text").text(i), setTimeout((function() {
    ...
    jQuery(window).on("elementor/frontend/init", (() => {
        elementorFrontend.hooks.addAction("frontend/element_ready/jkit_gallery.default", (e => {
